...
{
    /// <summary>
    /// Represents the sampler state filter
    /// </summary>
    ...
    public:
        /// <summary>
        /// Constructs a sampler state from the device handle with default settings
        /// </summary>
        /// <param name="device">Device handle</param>
        SamplerState(ID3D11Device* device);
        /// <summary>
        /// Constructs a sampler state from a device handle and a description
        /// </summary>
        /// <param name="device">Device handle</param>
        /// <param name="desc">Sampler state description</param>
        SamplerState(ID3D11Device* device, const SamplerStateDescription& desc);
        /// <summary>
        /// Gets a pointer to the GAPI sampler state instance
        /// </summary>
        /// <returns></returns>
