	...
	public partial class FPVCameraW : Form
	{
		...
		private void button5_Click(object sender, EventArgs e)
		{
			Result = new FPVCamera()
			{
				...
				MinDrawDist = Convert.ToSingle(Editor.ValidateNumberTextInput(textBox11.Text), Main.CultureInfo),
				MaxDrawDist = Convert.ToSingle(Editor.ValidateNumberTextInput(textBox12.Text), Main.CultureInfo),
				Sensibility = Convert.ToSingle(Editor.ValidateNumberTextInput(textBox5.Text), Main.CultureInfo),
				MovementSpeed = Convert.ToSingle(Editor.ValidateNumberTextInput(textBox13.Text), Main.CultureInfo),
