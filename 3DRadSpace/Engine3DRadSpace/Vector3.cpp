...
constexpr Vector3 Engine3DRadSpace::Math::Vector3::One()
{
...
{
    float x = X * m.M11 + Y * m.M12 + Z * m.M13 + m.M14;
    float y = X * m.M21 + Y * m.M22 + Z * m.M23 + m.M24;
    float z = X * m.M31 + Y * m.M32 + Z * m.M33 + m.M34;
