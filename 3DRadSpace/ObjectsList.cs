...
namespace _3DRadSpace
{
    public partial class ObjectsList : Form
    {
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            ...
            result = skinmesh.ShowDialog();
            Close();
        }

        private void ObjectsList_FormClosing(object sender, FormClosingEventArgs e)
        {
            DialogResult = result;
        }
    }
